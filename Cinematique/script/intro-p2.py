...
# === Chemins ===
chemin_video = os.path.abspath('../projet_info_Becile/Cinematique/vidéo/casino.mp4')
chemin_audio = os.path.abspath('C:../projet_info_Becile/Cinematique/music/Casino Sound Effect.mp3')
chemin_script_suivant = os.path.abspath("C:../projet_info_Becile/Cinematique/Dialogues/Dialogue-1.py")
